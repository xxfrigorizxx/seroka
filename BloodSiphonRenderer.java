...
import com.seroka.entity.BloodSiphonEntity;
...
/** Entonnoir de sang 3D — volume fermé teinté rouge rubis. */
public class BloodSiphonRenderer extends EntityRenderer<BloodSiphonEntity> {

  private static final ResourceLocation WATER_FLOW_SPRITE =
      ResourceLocation.withDefaultNamespace("block/water_flow");
  /** Rouge rubis vif translucide (#FF1020 avec alpha DD). */
  private static final int BLOOD_COLOR = FastColor.ARGB32.color(0xDD, 0xFF, 0x10, 0x20);

  private static final float WALL_THICKNESS = 0.20F;

  public BloodSiphonRenderer(EntityRendererProvider.Context context) {
    super(context);
  }

  @Override
  public void render(
      BloodSiphonEntity entity,
      float entityYaw,
      float partialTick,
      PoseStack poseStack,
  ...
  @Override
  public ResourceLocation getTextureLocation(BloodSiphonEntity entity) {
