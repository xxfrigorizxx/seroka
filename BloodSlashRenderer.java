...
import com.seroka.entity.BloodSlashEntity;
...
/** Croissant 3D de sang — lame translucide teintée rouge rubis. */
public class BloodSlashRenderer extends EntityRenderer<BloodSlashEntity> {

  private static final ResourceLocation WATER_FLOW_SPRITE =
      ResourceLocation.withDefaultNamespace("block/water_flow");

  private static final int BLOOD_COLOR = FastColor.ARGB32.color(0xEE, 0xFF, 0x08, 0x18);
  ...
  private void render3DCrescentMesh(
    ...
    for (int i = 0; i < segments; i++) {
      ...
      addQuad(builder, entry, x1In, halfH, z1In, x1Out, halfH, z1Out, x2Out, halfH, z2Out, x2In, halfH, z2In, minU1, maxU2, minV, maxV, light, 0.0F, 1.0F, 0.0F);
      addQuad(builder, entry, x2In, -halfH, z2In, x2Out, -halfH, z2Out, x1Out, -halfH, z1Out, x1In, -halfH, z1In, minU1, maxU2, minV, maxV, light, 0.0F, -1.0F, 0.0F);
      addQuad(builder, entry, x1Out, halfH, z1Out, x1Out, -halfH, z1Out, x2Out, -halfH, z2Out, x2Out, halfH, z2Out, minU1, maxU2, minV, maxV, light, x1Out, 0.0F, z1Out);
      addQuad(builder, entry, x2In, halfH, z2In, x2In, -halfH, z2In, x1In, -halfH, z1In, x1In, halfH, z1In, minU1, maxU2, minV, maxV, light, -x1In, 0.0F, -z1In);
    }
  }
