...
import com.seroka.entity.MegaPicTerreEntity;
...
/** Rendu du gros pic de terre — même modèle que la glace, texture du bloc visé. */
public class MegaPicTerreRenderer extends EntityRenderer<MegaPicTerreEntity> {

  private final MegaPicGlaceModel model;

  public MegaPicTerreRenderer(EntityRendererProvider.Context context) {
    super(context);
  ...
  public void render(
    ...
    BlockState state = entite.getBlockState();
    ...
    VertexConsumer vertices = new FlowingSpriteVertexConsumer(raw, sprite, 0.0F, 0.0F);
  ...
  private static float calculerRotationBascule(MegaPicTerreEntity entite, float deltaPartial) {
    if (entite.isChuting()) {
      return 90.0F;
    }
  ...
  @Override
  public ResourceLocation getTextureLocation(MegaPicTerreEntity entite) {
