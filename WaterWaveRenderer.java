...
import com.seroka.entity.WaterWaveEntity;
...
/** Rendu 3D Vague d'Eau — largeur en travers (axe X), profil déferlant vers l'avant (axe Z). */
public class WaterWaveRenderer extends EntityRenderer<WaterWaveEntity> {
  ...
  public WaterWaveRenderer(EntityRendererProvider.Context context) {
    super(context);
  }

  @Override
  public void render(
      WaterWaveEntity entity,
      float entityYaw,
      float partialTick,
      PoseStack poseStack,
  ...
  @Override
  public ResourceLocation getTextureLocation(WaterWaveEntity entity) {
